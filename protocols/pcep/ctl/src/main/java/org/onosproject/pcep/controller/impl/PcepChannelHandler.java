            ...
            void processPcepMessage(PcepChannelHandler h, PcepMessage m) throws IOException, PcepParseException {
                ...
                if (m.getType() != PcepType.OPEN) {
                    ...
                    if (h.capabilityValidation(pOpenmsg)) {
                        ...
                        log.info("Capability validation failed. Sending PCEP-ERROR message to PCC.");
        ...
        KEEPWAIT(false) {
            ...
            void processPcepMessage(PcepChannelHandler h, PcepMessage m) throws IOException, PcepParseException {
                ...
                if (m.getType() != PcepType.KEEP_ALIVE) {
                    ...
                    h.processUnknownMsg();
                    log.info("message is not KEEPALIVE message");
                } else {
    ...
    public void exceptionCaught(ChannelHandlerContext ctx, ExceptionEvent e) throws Exception {
        ...
        if (e.getCause() instanceof ReadTimeoutException) {
            ...
            if ((errorType == (byte) 0x0) && (errorValue == (byte) 0x0)) {
                log.info("HLK:Sending PCEP-ERROR message to PCC. Error type = {}  Error value = {}  Description: {}", errorType, errorValue, e.getCause().toString());
                processUnknownMsg();
            } else {
